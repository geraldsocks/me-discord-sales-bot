...
async function tweetWithLocalImage(tweetText, pathfileName) {
    // Format our image to base64
    const processedImage = await fs.readFileSync(`${pathfileName}`, { encoding: 'base64' });
...
module.exports = {
    ...
    tweetWithLocalImage: tweetWithLocalImage
};